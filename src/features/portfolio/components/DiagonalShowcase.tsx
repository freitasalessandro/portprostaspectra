...
const DiagonalShowcase = () => {
  return (
    <section className="py-24 md:py-32 relative overflow-hidden noise-overlay">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {cases.map((item, i) => (
            <motion.div
              ...
              className="group rounded-2xl border border-border/30 bg-card/20 backdrop-blur-sm hover:border-primary/50 transition-all duration-500 p-6 md:p-8 flex flex-col justify-between cursor-default relative overflow-hidden min-h-[220px] md:min-h-[260px]"
            >
